...
template<typename TNum, typename TCh, typename TCharCvt>
TNum StrToNum(const TCh* str, TCh** strEnd, int base, const std::basic_string<TCharCvt>& strCvt)
{
    TCharCvt*  strEndTmp = nullptr;
    const TNum result    = STo<TNum, TCharCvt>::Convert(strCvt.c_str(), &strEndTmp, base);
    if(strEnd)
        *strEnd = const_cast<TCh*>(str + std::distance(strCvt.c_str(), static_cast<const TCharCvt*>(strEndTmp)));
    return result;
}
}// namespace
...
TNum ToTNum(const Char32* str, Char32** strEnd, const int base)
{
    WStr strTmp;
    text::Utf32ToWStr(str, -1, strTmp);
    return StrToNum<TNum, Char32, WChar>(str, strEnd, base, strTmp);
}
}// namespace

I32 ToI32(const Char32* str, Char32** strEnd, const int base) { return ToTNum<I32>(str, strEnd, base); }
I64 ToI64(const Char32* str, Char32** strEnd, const int base) { return ToTNum<I64>(str, strEnd, base); }
U32 ToU32(const Char32* str, Char32** strEnd, const int base) { return ToTNum<U32>(str, strEnd, base); }
U64 ToU64(const Char32* str, Char32** strEnd, const int base) { return ToTNum<U64>(str, strEnd, base); }
F32 ToF32(const Char32* str, Char32** strEnd) { return ToTNum<F32>(str, strEnd, 0); }
F64 ToF64(const Char32* str, Char32** strEnd) { return ToTNum<F64>(str, strEnd, 0); }
...
{
template<typename TNum>
TNum ToTNum(const Char16* str, Char16** strEnd, const int base)
{
    WStr strTmp;
    text::Utf16ToWStr(str, -1, strTmp);
    return StrToNum<TNum, Char16, WChar>(str, strEnd, base, strTmp);
}
}// namespace

I32 ToI32(const Char16* str, Char16** strEnd, const int base) { return ToTNum<I32>(str, strEnd, base); }
I64 ToI64(const Char16* str, Char16** strEnd, const int base) { return ToTNum<I64>(str, strEnd, base); }
U32 ToU32(const Char16* str, Char16** strEnd, const int base) { return ToTNum<U32>(str, strEnd, base); }
U64 ToU64(const Char16* str, Char16** strEnd, const int base) { return ToTNum<U64>(str, strEnd, base); }
F32 ToF32(const Char16* str, Char16** strEnd) { return ToTNum<F32>(str, strEnd, 0); }
F64 ToF64(const Char16* str, Char16** strEnd) { return ToTNum<F64>(str, strEnd, 0); }
